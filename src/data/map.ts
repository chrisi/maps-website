...
export const maps: Theater[] = [
  {
    ...
    projection: "+proj=tmerc +lon_0=127.5 +ellps=WGS84 +k=0.9996 +units=m +x_0=512000 +y_0=-3.74929e+06",
  ...
  },
  {
    ...
    projection: "+proj=tmerc +lon_0=16.4191 +ellps=WGS84 +k=0.9996 +units=m +x_0=512000 +y_0=-4.1192e+06",
  ...
  {
    name: "israel",
    datum: {lat: 31.5, long: 35.0}, // this might be v1 map datum
    projection: "+proj=tmerc +lon_0=35 +ellps=WGS84 +k=0.9996 +units=m +x_0=512000 +y_0=-3.02844e+06",
    feet: MapSizeFeet, // theater size, 1024 km
    pixels: 6144, // map image size
    resolution: MapSizeFeet / 6144, // approx 546.8
    px2nm: FtPerNM / (MapSizeFeet / 6144), // approx 11.11 pixels per NM
  ...
  {
    name: "hellas",
    datum: {lat: 38.0069, long: 25.0150}, // this might be v1 map datum
    projection: "+proj=tmerc +lon_0=25 +ellps=WGS84 +k=0.9996 +units=m +x_0=512000 +y_0=-3.69382e+06",
    feet: MapSizeFeet, // theater size, 1024 km
    pixels: 6144, // map image size
    resolution: MapSizeFeet / 6144, // approx 546.8
    px2nm: FtPerNM / (MapSizeFeet / 6144), // approx 11.11 pixels per NM
