...
export class DebugOverlay extends BaseOverlay {
  ...
  public onDraw(cnv: Canvas): void {
    ...
    drawNavTacan(cnv.context, {x: 300, y: 100}, 2, 'white', true)

    drawAirbase(cnv.context, {x: 350, y: 100}, 45, 1.5, 'white', false)
    drawAirbase(cnv.context, {x: 400, y: 100}, 45, 1.5, 'white', true)
    drawAirbase(cnv.context, {x: 450, y: 100}, 45, 1.5, 'white', false, true)
